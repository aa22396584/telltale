...
| MAF 感測器 | MAF sensor | lib/l10n/app_en.arb:2795 ↔ lib/l10n/app_zh_Hant.arb:919 (T1 same ARB key) | evidenced | INCONSISTENCY: this uses 感測器 while the readiness monitor label uses 感知器 for oxygen sensor (lib/l10n/app_zh_Hant.arb:177 '含氧感知器', dtcMonitorOxygenSensor). Both ship. Label moved out of AirflowSource.label into the ARBs so lib/obd stays Flutter-free; the enum still carries the identity. |
| OBD2 故障診斷 | OBD2 fault diagnosis | README.md:11 ↔ README.zh-TW.md:11 (T1 same sentence) | evidenced |  |
| Speed-Density 推算 | Speed-density estimate | lib/l10n/app_en.arb:2799 ↔ lib/l10n/app_zh_Hant.arb:920 (T1 same ARB key) | evidenced | Was proposed while the label lived in physics_engine.dart, which had no English at all. The English now ships and says estimate — the load-bearing half, because this figure is computed from RPM, MAP and IAT rather than read off a sensor. |
...
| 二次空氣噴射 | secondary air | lib/l10n/app_en.arb:2737 ↔ lib/l10n/app_zh_Hant.arb:180 (T1 same ARB key) | evidenced | Label moved out of ReadinessMonitor.secondaryAir into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 公式錯誤 | formula error | lib/l10n/app_en.arb:823 ↔ lib/l10n/app_zh_Hant.arb:121 (T1 same ARB key) | evidenced |  |
| 凍結幀 | freeze frame | README.md:56 'freeze frames' ↔ README.zh-TW.md:50 '凍結幀' (T1); docs/field-guide.zh-TW.md:213 heading | evidenced |  |
| 動力系統 | powertrain | lib/l10n/app_en.arb:1277 ↔ lib/l10n/app_zh_Hant.arb:759 (T1 same ARB key) | evidenced | Distinct from '大電池' used for 'powertrain battery' at README.md:58 ↔ README.zh-TW.md:52. Same English word, two zh renderings by domain. |
| 化學計量比推算 | Stoichiometric estimate | lib/l10n/app_en.arb:2807 ↔ lib/l10n/app_zh_Hant.arb:922 (T1 same ARB key) | evidenced |  |
...
| 含氧感知器 | oxygen sensor | lib/l10n/app_en.arb:638 ↔ lib/l10n/app_zh_Hant.arb:177 (T1 same ARB key `dtcMonitorOxygenSensor`) | evidenced | 感知器 (TW) not 傳感器 (CN). Label moved out of ReadinessMonitor.oxygenSensor into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
| 增壓壓力 | boost pressure | lib/l10n/app_en.arb:590 ↔ lib/l10n/app_zh_Hant.arb:165 (T1 same ARB key `dtcMonitorBoostPressure`) | evidenced | Label moved out of ReadinessMonitor.boostPressure into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 失火監控 | misfire | lib/l10n/app_en.arb:2627 ↔ lib/l10n/app_zh_Hant.arb:174 (T1 same ARB key) | evidenced | Label moved out of ReadinessMonitor.misfire into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 已儲存 | stored | lib/l10n/app_en.arb:481 ↔ lib/l10n/app_zh_Hant.arb:753 (T1 same ARB key) | evidenced | Moved out of DtcKind when lib/obd/ stopped carrying screen copy. The enum still holds 已儲存 as `transcriptLabel`, which is export copy and stays Chinese in every locale — do not cite that as the UI translation. |
| 底盤 | chassis | lib/l10n/app_en.arb:2609 ↔ lib/l10n/app_zh_Hant.arb:760 (T1 same ARB key `dtcSystemChassis`) | evidenced |  |
| 待確認 | pending | lib/l10n/app_en.arb:481 ↔ lib/l10n/app_zh_Hant.arb:754 (T1 same ARB key) | evidenced | Not 'detected' and not 'confirmed': a Mode 07 code has been seen once and has not reached the confirmation threshold. |
| 微粒濾清器 | particulate filter | lib/l10n/app_en.arb:618 ↔ lib/l10n/app_zh_Hant.arb:179 (T1 same ARB key) | evidenced |  |
...
| 排氣感知器 | exhaust sensor | lib/l10n/app_en.arb:610 ↔ lib/l10n/app_zh_Hant.arb:170 (T1 same ARB key `dtcMonitorExhaustSensor`) | evidenced | Label moved out of ReadinessMonitor.exhaustSensor into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 永久 | permanent | lib/l10n/app_en.arb:2589 ↔ lib/l10n/app_zh_Hant.arb:755 (T1 same ARB key) | evidenced | A permanent code is NOT clearable, and English copy must never imply that pressing Clear removes it. dtcKindPermanentExplanation (lib/l10n/app_en.arb:2601 ↔ lib/l10n/app_zh_Hant.arb:758) carries 無法用診斷儀清除，需修復後由 ECU 自行確認 and its English; dtcClearDialogBody (lib/l10n/app_en.arb:481 ↔ lib/l10n/app_zh_Hant.arb:142) repeats it beside the Clear button. #45 names this explicitly |
| 汽油微粒濾清器（GPF） | gasoline particulate filter (GPF) | lib/l10n/app_en.arb:618 ↔ lib/l10n/app_zh_Hant.arb:172 (T1 same ARB key `dtcMonitorGasolineParticulateFilter`) | evidenced | LOAD-BEARING: field-guide:247-249 says many OBD tables mistranslate this bit as 空調冷媒 (A/C refrigerant) and that is wrong. Keep GPF in the string. |
| 無回應，稍後重試 | no answer | lib/l10n/app_en.arb:752 ↔ lib/l10n/app_zh_Hant.arb:126 (T1 same ARB key) | evidenced |  |
| 燃油系統監控 | fuel system | lib/l10n/app_en.arb:614 ↔ lib/l10n/app_zh_Hant.arb:171 (T1 same ARB key `dtcMonitorFuelSystem`) | evidenced | Label moved out of ReadinessMonitor.fuelSystem into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 綜合元件監控 | components | lib/l10n/app_en.arb:598 ↔ lib/l10n/app_zh_Hant.arb:167 (T1 same ARB key) | evidenced |  |
| 網路 | network | lib/l10n/app_en.arb:52 ↔ lib/l10n/app_zh_Hant.arb:762 (T1 same ARB key) | evidenced |  |
| 自訂 PID | custom PID | README.md:56 'custom PIDs' ↔ README.zh-TW.md:50 '自訂 PID' (T1) | evidenced |  |
| 蒸發排放系統 | evaporative | lib/l10n/app_en.arb:608 ↔ lib/l10n/app_zh_Hant.arb:169 (T1 same ARB key) | evidenced | The English ships as "Evaporative system" — the evaporative emission system, not the exhaust. Label moved out of ReadinessMonitor.evaporative into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
| 觸媒轉換器 | catalyst | lib/l10n/app_en.arb:622 ↔ lib/l10n/app_zh_Hant.arb:166 (T1 same ARB key) | evidenced | Label moved out of ReadinessMonitor.catalyst into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 車身 | body | lib/l10n/app_en.arb:2613 ↔ lib/l10n/app_zh_Hant.arb:761 (T1 same ARB key) | evidenced |  |
...
| Language / 語言 | Language / 語言 | lib/l10n/app_en.arb:909 ↔ lib/l10n/app_zh_Hant.arb:250 (T1 same ARB key) | evidenced | DO NOT localize. app_en.arb:10 description: 'Bilingual label for the language picker. Options use self-names.' |
...
| 刪除 | delete | lib/l10n/app_en.arb:1987 ↔ lib/l10n/app_zh_Hant.arb:278 (T1 same ARB key) | evidenced |  |
| 匯出 | export | lib/l10n/app_en.arb:2068 ↔ lib/l10n/app_zh_Hant.arb:596 (T1); README.md:57 'export' ↔ README.zh-TW.md:51 '匯出' | evidenced |  |
| 回放 | replay | lib/l10n/app_en.arb:1990 ↔ lib/l10n/app_zh_Hant.arb:569 (T1 same ARB key) | evidenced |  |
...
| 重試 | Retry | lib/l10n/app_en.arb:728 ↔ lib/l10n/app_zh_Hant.arb:197 (T1 same ARB key) | evidenced |  |
...
| 繁體中文 | English | Evidence | Status | Note |
|---|---|---|---|---|
| 資料已過期 | stale | lib/l10n/app_en.arb:329 ↔ lib/l10n/app_zh_Hant.arb:666 (T1 same ARB key) | evidenced | #45 names this explicitly: stale ≠ live. A reading that stopped updating is not a current one, and must never render as though it were |
| ECU 回報 | ECU reported | lib/l10n/app_en.arb:443 ↔ lib/l10n/app_zh_Hant.arb:730 (T1 same ARB key, `derivedEcuReported`) | evidenced | The identifier for the fuel case says `measured`; both shipped strings say the ECU reported it. #44 forbids rendering 推算/estimate as measured, and using the bare word for the true case invites exactly that slip, so the English names the reporter rather than the act of measuring. `derivedFuelSourceEcu` briefly held a second, byte-identical copy of this sentence and was merged away. |
...
| 原廠資料 | manufacturer data | lib/l10n/app_en.arb:2874 ↔ lib/l10n/app_zh_Hant.arb:947 (T1 same ARB key) | evidenced | The English was 'manufacturer publication' here while nothing shipped it. What ships is 'manufacturer data': shorter, and 'publication' invites the reader to expect a document they can go and read. |
...
| 官方型錄 | official registry | lib/l10n/app_en.arb:2870 ↔ lib/l10n/app_zh_Hant.arb:946 (T1 same ARB key) | evidenced | The strongest of the five origins. It must not be worded so as to sound like a measurement of this car — it is a record about this model. |
...
| 通用預設 | generic default | lib/l10n/app_en.arb:2862 ↔ lib/l10n/app_zh_Hant.arb:944 (T1 same ARB key) | evidenced | The weakest of the five origins, and the one a reader most needs to spot: it means the estimate is about a car, not about their car. |
| 模型係數 | model coefficient | lib/l10n/app_en.arb:2878 ↔ lib/l10n/app_zh_Hant.arb:948 (T1 same ARB key) | evidenced | A number from a physical model rather than from this vehicle. Never 'measured' and never 'official' — #44's rule about 推算 applies to it directly. |
