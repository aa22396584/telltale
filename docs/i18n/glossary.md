...
| 內建模擬器 | built-in simulator | lib/l10n/app_en.arb:13 connectBody ↔ lib/l10n/app_zh_Hant.arb:10 (T1) | evidenced | The in-app label is 'Demo 模擬器' (docs/field-guide.zh-TW.md:27); the ARB says 內建模擬器; README says Demo ECU. Pick per surface, do not unify silently. |
...
| 車輛即時遙測 | Live vehicle telemetry | lib/l10n/app_en.arb:7 appTagline ↔ lib/l10n/app_zh_Hant.arb:7 (T1 same ARB key); also README.md:10 'real-time vehicle telemetry' ↔ README.zh-TW.md:10 | evidenced | Also the Google Play store name suffix. Use verbatim for appTagline. |
...
| 選擇連線方式 | Choose a connection | lib/l10n/app_en.arb:12 connectHeadline ↔ lib/l10n/app_zh_Hant.arb:9 (T1); store/README.md:12 '01-connect.png … 選擇連線方式' | evidenced |  |
| 電門 | ignition | lib/l10n/app_en.arb:13 'switch the ignition on' ↔ lib/l10n/app_zh_Hant.arb:10 '開啟電門' (T1) | evidenced | 電門 (not 點火/鑰匙門). Reused throughout docs/field-guide.zh-TW.md:59,145,146,267,298. |
...
| 刪除 | delete | lib/l10n/app_en.arb:22 ↔ lib/l10n/app_zh_Hant.arb:16 (T1) | evidenced |  |
| 匯出 | export | lib/l10n/app_en.arb:22 ↔ lib/l10n/app_zh_Hant.arb:16 (T1); README.md:57 'export' ↔ README.zh-TW.md:51 '匯出' | evidenced |  |
| 回放 | replay | lib/l10n/app_en.arb:22 startupRetryHint 'Recording, replay, export and delete' ↔ lib/l10n/app_zh_Hant.arb:16 '紀錄、回放、匯出或刪除' (T1) | evidenced |  |
| 外觀 | Appearance | lib/l10n/app_en.arb:25 appearanceSectionTitle ↔ lib/l10n/app_zh_Hant.arb:19 (T1) | evidenced |  |
...
| 重試 | Retry | lib/l10n/app_en.arb:20 startupRetry ↔ lib/l10n/app_zh_Hant.arb:14 (T1) | evidenced |  |
