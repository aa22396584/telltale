...
| MAF 感測器 | MAF sensor | lib/l10n/app_en.arb:2897 ↔ lib/l10n/app_zh_Hant.arb:942 (T1 same ARB key) | evidenced | INCONSISTENCY: this uses 感測器 while the readiness monitor label uses 感知器 for oxygen sensor (lib/l10n/app_zh_Hant.arb:190 '含氧感知器', dtcMonitorOxygenSensor). Both ship. Label moved out of AirflowSource.label into the ARBs so lib/obd stays Flutter-free; the enum still carries the identity. |
| OBD2 故障診斷 | OBD2 fault diagnosis | README.md:11 ↔ README.zh-TW.md:11 (T1 same sentence) | evidenced |  |
| Speed-Density 推算 | Speed-density estimate | lib/l10n/app_en.arb:2901 ↔ lib/l10n/app_zh_Hant.arb:943 (T1 same ARB key) | evidenced | Was proposed while the label lived in physics_engine.dart, which had no English at all. The English now ships and says estimate — the load-bearing half, because this figure is computed from RPM, MAP and IAT rather than read off a sensor. |
...
| 二次空氣噴射 | secondary air | lib/l10n/app_en.arb:2839 ↔ lib/l10n/app_zh_Hant.arb:193 (T1 same ARB key) | evidenced | Label moved out of ReadinessMonitor.secondaryAir into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 公式錯誤 | formula error | lib/l10n/app_en.arb:875 ↔ lib/l10n/app_zh_Hant.arb:121 (T1 same ARB key) | evidenced |  |
| 凍結幀 | freeze frame | README.md:56 'freeze frames' ↔ README.zh-TW.md:50 '凍結幀' (T1); docs/field-guide.zh-TW.md:213 heading | evidenced |  |
| 動力系統 | powertrain | lib/l10n/app_en.arb:1368 ↔ lib/l10n/app_zh_Hant.arb:782 (T1 same ARB key) | evidenced | Distinct from '大電池' used for 'powertrain battery' at README.md:58 ↔ README.zh-TW.md:52. Same English word, two zh renderings by domain. |
| 化學計量比推算 | Stoichiometric estimate | lib/l10n/app_en.arb:2909 ↔ lib/l10n/app_zh_Hant.arb:945 (T1 same ARB key) | evidenced |  |
...
| 含氧感知器 | oxygen sensor | lib/l10n/app_en.arb:690 ↔ lib/l10n/app_zh_Hant.arb:190 (T1 same ARB key `dtcMonitorOxygenSensor`) | evidenced | 感知器 (TW) not 傳感器 (CN). Label moved out of ReadinessMonitor.oxygenSensor into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
| 增壓壓力 | boost pressure | lib/l10n/app_en.arb:642 ↔ lib/l10n/app_zh_Hant.arb:178 (T1 same ARB key `dtcMonitorBoostPressure`) | evidenced | Label moved out of ReadinessMonitor.boostPressure into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
| 多幀 | multi-frame | docs/verification/review-log.md:41 '### C2 · 多幀長度行被當成資料' + :43 naming `_parse` ↔ lib/obd/elm327_client.dart:4 'multi-frame reassembly' and :2482 "a multi-frame envelope's total length" (T3, same named function) | inferred | zh at docs/verification/review-log.md:41; en at lib/obd/elm327_client.dart:4. Both are this project's words, never written side by side. |
| 失火監控 | misfire | lib/l10n/app_en.arb:2729 ↔ lib/l10n/app_zh_Hant.arb:187 (T1 same ARB key) | evidenced | Label moved out of ReadinessMonitor.misfire into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 已儲存 | stored | lib/l10n/app_en.arb:481 ↔ lib/l10n/app_zh_Hant.arb:776 (T1 same ARB key) | evidenced | Moved out of DtcKind when lib/obd/ stopped carrying screen copy. The enum still holds 已儲存 as `transcriptLabel`, which is export copy and stays Chinese in every locale — do not cite that as the UI translation. |
| 底盤 | chassis | lib/l10n/app_en.arb:2711 ↔ lib/l10n/app_zh_Hant.arb:783 (T1 same ARB key `dtcSystemChassis`) | evidenced |  |
| 待確認 | pending | lib/l10n/app_en.arb:481 ↔ lib/l10n/app_zh_Hant.arb:777 (T1 same ARB key) | evidenced | Not 'detected' and not 'confirmed': a Mode 07 code has been seen once and has not reached the confirmation threshold. |
| 微粒濾清器 | particulate filter | lib/l10n/app_en.arb:670 ↔ lib/l10n/app_zh_Hant.arb:192 (T1 same ARB key) | evidenced |  |
...
| 排氣感知器 | exhaust sensor | lib/l10n/app_en.arb:662 ↔ lib/l10n/app_zh_Hant.arb:183 (T1 same ARB key `dtcMonitorExhaustSensor`) | evidenced | Label moved out of ReadinessMonitor.exhaustSensor into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
| 控制器 | controller | lib/state/dtc_scan.dart:47 'Controllers that gave this category a terminal answer.' ↔ same file :646 '控制器 … 回報…' (T3 same file); docs/field-guide.zh-TW.md:206 | inferred | zh at lib/state/dtc_scan.dart:646; en at :47 of the same file, 599 lines away — not one place. |
...
| 故障燈 | MIL | lib/obd/polling_engine.dart:2979 (T3) | inferred | The app ships 故障燈 in Chinese prose and MIL only inside an English PID name (`Distance Travelled With MIL On`); no place writes both, so the pairing is this glossary's. Spell it out on first mention in English if the audience may not know the acronym |
| 永久 | permanent | lib/l10n/app_en.arb:2691 ↔ lib/l10n/app_zh_Hant.arb:778 (T1 same ARB key) | evidenced | A permanent code is NOT clearable, and English copy must never imply that pressing Clear removes it. dtcKindPermanentExplanation (lib/l10n/app_en.arb:2703 ↔ lib/l10n/app_zh_Hant.arb:781) carries 無法用診斷儀清除，需修復後由 ECU 自行確認 and its English; dtcClearDialogBody (lib/l10n/app_en.arb:481 ↔ lib/l10n/app_zh_Hant.arb:142) repeats it beside the Clear button. #45 names this explicitly |
| 汽油微粒濾清器（GPF） | gasoline particulate filter (GPF) | lib/l10n/app_en.arb:670 ↔ lib/l10n/app_zh_Hant.arb:185 (T1 same ARB key `dtcMonitorGasolineParticulateFilter`) | evidenced | LOAD-BEARING: field-guide:247-249 says many OBD tables mistranslate this bit as 空調冷媒 (A/C refrigerant) and that is wrong. Keep GPF in the string. |
| 無回應，稍後重試 | no answer | lib/l10n/app_en.arb:804 ↔ lib/l10n/app_zh_Hant.arb:126 (T1 same ARB key) | evidenced |  |
| 燃油系統監控 | fuel system | lib/l10n/app_en.arb:666 ↔ lib/l10n/app_zh_Hant.arb:184 (T1 same ARB key `dtcMonitorFuelSystem`) | evidenced | Label moved out of ReadinessMonitor.fuelSystem into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 綜合元件監控 | components | lib/l10n/app_en.arb:650 ↔ lib/l10n/app_zh_Hant.arb:180 (T1 same ARB key) | evidenced |  |
| 網路 | network | lib/l10n/app_en.arb:52 ↔ lib/l10n/app_zh_Hant.arb:785 (T1 same ARB key) | evidenced |  |
| 自訂 PID | custom PID | README.md:56 'custom PIDs' ↔ README.zh-TW.md:50 '自訂 PID' (T1) | evidenced |  |
| 蒸發排放系統 | evaporative | lib/l10n/app_en.arb:660 ↔ lib/l10n/app_zh_Hant.arb:182 (T1 same ARB key) | evidenced | The English ships as "Evaporative system" — the evaporative emission system, not the exhaust. Label moved out of ReadinessMonitor.evaporative into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
| 觸媒轉換器 | catalyst | lib/l10n/app_en.arb:674 ↔ lib/l10n/app_zh_Hant.arb:179 (T1 same ARB key) | evidenced | Label moved out of ReadinessMonitor.catalyst into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 車身 | body | lib/l10n/app_en.arb:2715 ↔ lib/l10n/app_zh_Hant.arb:784 (T1 same ARB key) | evidenced |  |
...
| Language / 語言 | Language / 語言 | lib/l10n/app_en.arb:961 ↔ lib/l10n/app_zh_Hant.arb:263 (T1 same ARB key) | evidenced | DO NOT localize. app_en.arb:10 description: 'Bilingual label for the language picker. Options use self-names.' |
...
| 刪除 | delete | lib/l10n/app_en.arb:2089 ↔ lib/l10n/app_zh_Hant.arb:291 (T1 same ARB key) | evidenced |  |
| 匯出 | export | lib/l10n/app_en.arb:2170 ↔ lib/l10n/app_zh_Hant.arb:619 (T1); README.md:57 'export' ↔ README.zh-TW.md:51 '匯出' | evidenced |  |
| 回放 | replay | lib/l10n/app_en.arb:2092 ↔ lib/l10n/app_zh_Hant.arb:592 (T1 same ARB key) | evidenced |  |
...
| 重試 | Retry | lib/l10n/app_en.arb:780 ↔ lib/l10n/app_zh_Hant.arb:210 (T1 same ARB key) | evidenced |  |
...
| 繁體中文 | English | Evidence | Status | Note |
|---|---|---|---|---|
| 資料已過期 | stale | lib/l10n/app_en.arb:329 ↔ lib/l10n/app_zh_Hant.arb:689 (T1 same ARB key) | evidenced | #45 names this explicitly: stale ≠ live. A reading that stopped updating is not a current one, and must never render as though it were |
| ECU 回報 | ECU reported | lib/l10n/app_en.arb:443 ↔ lib/l10n/app_zh_Hant.arb:753 (T1 same ARB key, `derivedEcuReported`) | evidenced | The identifier for the fuel case says `measured`; both shipped strings say the ECU reported it. #44 forbids rendering 推算/estimate as measured, and using the bare word for the true case invites exactly that slip, so the English names the reporter rather than the act of measuring. `derivedFuelSourceEcu` briefly held a second, byte-identical copy of this sentence and was merged away. |
| VE | VE | README.md:75 ↔ README.zh-TW.md:65 (T1 — unchanged); spelled out as 容積效率 in lib/obd/session_evidence.dart:213 'volumetricEfficiency' | evidenced |  |
...
| 原廠資料 | manufacturer data | lib/l10n/app_en.arb:2976 ↔ lib/l10n/app_zh_Hant.arb:970 (T1 same ARB key) | evidenced | The English was 'manufacturer publication' here while nothing shipped it. What ships is 'manufacturer data': shorter, and 'publication' invites the reader to expect a document they can go and read. |
...
| 官方型錄 | official registry | lib/l10n/app_en.arb:2972 ↔ lib/l10n/app_zh_Hant.arb:969 (T1 same ARB key) | evidenced | The strongest of the five origins. It must not be worded so as to sound like a measurement of this car — it is a record about this model. |
| 容積效率 | volumetric efficiency | lib/obd/session_evidence.dart:213 'volumetricEfficiency' => '容積效率' (T3) | evidenced |  |
...
| 排氣量 | displacement | lib/obd/session_evidence.dart:211 'displacementL' => '排氣量' (T3 key ↔ label); docs/field-guide.zh-TW.md:164 | evidenced |  |
| 正面投影面積 | frontal area | lib/obd/session_evidence.dart:217 'frontalAreaM2' => '正面投影面積' (T3) | evidenced |  |
| 油耗 | fuel estimate | README.md:77-78 ↔ README.zh-TW.md:67 (T1); docs/field-guide.zh-TW.md:163 '推算數值（馬力、扭力、油耗）' | evidenced |  |
| 滾動阻力係數 | rolling resistance | lib/obd/session_evidence.dart:218 'rollingResistance' => '滾動阻力係數' (T3) | evidenced |  |
| 燃料種類 | fuel type | lib/obd/session_evidence.dart:214 'fuelType' => '燃料種類' (T3) | evidenced |  |
...
| 車重 | mass | README.md:75 'does not infer mass, torque, drag, VE' ↔ README.zh-TW.md:65 '不推測車重、扭力、風阻、VE' (T1); lib/obd/session_evidence.dart:212 'massKg' => '車重' | evidenced |  |
| 通用預設 | generic default | lib/l10n/app_en.arb:2964 ↔ lib/l10n/app_zh_Hant.arb:967 (T1 same ARB key) | evidenced | The weakest of the five origins, and the one a reader most needs to spot: it means the estimate is about a car, not about their car. |
| 模型係數 | model coefficient | lib/l10n/app_en.arb:2980 ↔ lib/l10n/app_zh_Hant.arb:971 (T1 same ARB key) | evidenced | A number from a physical model rather than from this vehicle. Never 'measured' and never 'official' — #44's rule about 推算 applies to it directly. |
...
| 風阻 | drag | README.md:75 ↔ README.zh-TW.md:65 (T1); lib/obd/session_evidence.dart:216 'dragCoefficient' => '風阻係數' | evidenced |  |
...
| 驅動方式 | drivetrain | lib/obd/session_evidence.dart:215 'drivetrain' => '驅動方式' (T3); README.zh-TW.md:66 '風阻與驅動方式' | evidenced |  |
