...
| MAF 感測器 | MAF sensor | lib/l10n/app_en.arb:2913 ↔ lib/l10n/app_zh_Hant.arb:943 (T1 same ARB key) | evidenced | INCONSISTENCY: this uses 感測器 while the readiness monitor label uses 感知器 for oxygen sensor (lib/l10n/app_zh_Hant.arb:190 '含氧感知器', dtcMonitorOxygenSensor). Both ship. Label moved out of AirflowSource.label into the ARBs so lib/obd stays Flutter-free; the enum still carries the identity. |
| OBD2 故障診斷 | OBD2 fault diagnosis | README.md:11 ↔ README.zh-TW.md:11 (T1 same sentence) | evidenced |  |
| Speed-Density 推算 | Speed-density estimate | lib/l10n/app_en.arb:2917 ↔ lib/l10n/app_zh_Hant.arb:944 (T1 same ARB key) | evidenced | Was proposed while the label lived in physics_engine.dart, which had no English at all. The English now ships and says estimate — the load-bearing half, because this figure is computed from RPM, MAP and IAT rather than read off a sensor. |
...
| 二次空氣噴射 | secondary air | lib/l10n/app_en.arb:2855 ↔ lib/l10n/app_zh_Hant.arb:193 (T1 same ARB key) | evidenced | Label moved out of ReadinessMonitor.secondaryAir into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 動力系統 | powertrain | lib/l10n/app_en.arb:1384 ↔ lib/l10n/app_zh_Hant.arb:783 (T1 same ARB key) | evidenced | Distinct from '大電池' used for 'powertrain battery' at README.md:58 ↔ README.zh-TW.md:52. Same English word, two zh renderings by domain. |
| 化學計量比推算 | Stoichiometric estimate | lib/l10n/app_en.arb:2925 ↔ lib/l10n/app_zh_Hant.arb:946 (T1 same ARB key) | evidenced |  |
...
| 多幀 | multi-frame | docs/verification/review-log.md:41 '### C2 · 多幀長度行被當成資料' + :43 naming `_parse` ↔ lib/obd/elm327_client.dart:4 'multi-frame reassembly' and :2560 "a multi-frame envelope's total length" (T3, same named function) | inferred | zh at docs/verification/review-log.md:41; en at lib/obd/elm327_client.dart:4. Both are this project's words, never written side by side. |
| 失火監控 | misfire | lib/l10n/app_en.arb:2745 ↔ lib/l10n/app_zh_Hant.arb:187 (T1 same ARB key) | evidenced | Label moved out of ReadinessMonitor.misfire into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 已儲存 | stored | lib/l10n/app_en.arb:489 ↔ lib/l10n/app_zh_Hant.arb:777 (T1 same ARB key) | evidenced | Moved out of DtcKind when lib/obd/ stopped carrying screen copy. The enum still holds 已儲存 as `transcriptLabel`, which is export copy and stays Chinese in every locale — do not cite that as the UI translation. |
| 底盤 | chassis | lib/l10n/app_en.arb:2727 ↔ lib/l10n/app_zh_Hant.arb:784 (T1 same ARB key `dtcSystemChassis`) | evidenced |  |
| 待確認 | pending | lib/l10n/app_en.arb:489 ↔ lib/l10n/app_zh_Hant.arb:778 (T1 same ARB key) | evidenced | Not 'detected' and not 'confirmed': a Mode 07 code has been seen once and has not reached the confirmation threshold. |
...
| 永久 | permanent | lib/l10n/app_en.arb:2707 ↔ lib/l10n/app_zh_Hant.arb:779 (T1 same ARB key) | evidenced | A permanent code is NOT clearable, and English copy must never imply that pressing Clear removes it. dtcKindPermanentExplanation (lib/l10n/app_en.arb:2719 ↔ lib/l10n/app_zh_Hant.arb:782) carries 無法用診斷儀清除，需修復後由 ECU 自行確認 and its English; dtcClearDialogBody (lib/l10n/app_en.arb:489 ↔ lib/l10n/app_zh_Hant.arb:142) repeats it beside the Clear button. #45 names this explicitly |
...
| 車身 | body | lib/l10n/app_en.arb:2731 ↔ lib/l10n/app_zh_Hant.arb:785 (T1 same ARB key) | evidenced |  |
...
| 刪除 | delete | lib/l10n/app_en.arb:2105 ↔ lib/l10n/app_zh_Hant.arb:291 (T1 same ARB key) | evidenced |  |
| 匯出 | export | lib/l10n/app_en.arb:2186 ↔ lib/l10n/app_zh_Hant.arb:620 (T1); README.md:57 'export' ↔ README.zh-TW.md:51 '匯出' | evidenced |  |
| 回放 | replay | lib/l10n/app_en.arb:2108 ↔ lib/l10n/app_zh_Hant.arb:593 (T1 same ARB key) | evidenced |  |
...
| 繁體中文 | English | Evidence | Status | Note |
|---|---|---|---|---|
| 資料已過期 | stale | lib/l10n/app_en.arb:337 ↔ lib/l10n/app_zh_Hant.arb:690 (T1 same ARB key) | evidenced | #45 names this explicitly: stale ≠ live. A reading that stopped updating is not a current one, and must never render as though it were |
| ECU 回報 | ECU reported | lib/l10n/app_en.arb:451 ↔ lib/l10n/app_zh_Hant.arb:754 (T1 same ARB key, `derivedEcuReported`) | evidenced | The identifier for the fuel case says `measured`; both shipped strings say the ECU reported it. #44 forbids rendering 推算/estimate as measured, and using the bare word for the true case invites exactly that slip, so the English names the reporter rather than the act of measuring. `derivedFuelSourceEcu` briefly held a second, byte-identical copy of this sentence and was merged away. |
...
| 原廠資料 | manufacturer data | lib/l10n/app_en.arb:2992 ↔ lib/l10n/app_zh_Hant.arb:971 (T1 same ARB key) | evidenced | The English was 'manufacturer publication' here while nothing shipped it. What ships is 'manufacturer data': shorter, and 'publication' invites the reader to expect a document they can go and read. |
...
| 官方型錄 | official registry | lib/l10n/app_en.arb:2988 ↔ lib/l10n/app_zh_Hant.arb:970 (T1 same ARB key) | evidenced | The strongest of the five origins. It must not be worded so as to sound like a measurement of this car — it is a record about this model. |
...
| 通用預設 | generic default | lib/l10n/app_en.arb:2980 ↔ lib/l10n/app_zh_Hant.arb:968 (T1 same ARB key) | evidenced | The weakest of the five origins, and the one a reader most needs to spot: it means the estimate is about a car, not about their car. |
| 模型係數 | model coefficient | lib/l10n/app_en.arb:2996 ↔ lib/l10n/app_zh_Hant.arb:972 (T1 same ARB key) | evidenced | A number from a physical model rather than from this vehicle. Never 'measured' and never 'official' — #44's rule about 推算 applies to it directly. |
