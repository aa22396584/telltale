...
| MAF 感測器 | MAF sensor | lib/l10n/app_en.arb:2739 ↔ lib/l10n/app_zh_Hant.arb:904 (T1 same ARB key) | evidenced | INCONSISTENCY: this uses 感測器 while the readiness monitor label uses 感知器 for oxygen sensor (lib/l10n/app_zh_Hant.arb, dtcMonitorOxygenSensor). Both ship. Label moved out of AirflowSource.label into the ARBs so lib/obd stays Flutter-free; the enum still carries the identity. |
| OBD2 故障診斷 | OBD2 fault diagnosis | README.md:11 ↔ README.zh-TW.md:11 (T1 same sentence) | evidenced |  |
| Speed-Density 推算 | Speed-density estimate | lib/l10n/app_en.arb:2743 ↔ lib/l10n/app_zh_Hant.arb:905 (T1 same ARB key) | evidenced | Was proposed while the label lived in physics_engine.dart, which had no English at all. The English now ships and says estimate — the load-bearing half, because this figure is computed from RPM, MAP and IAT rather than read off a sensor. |
...
| 二次空氣噴射 | secondary air | lib/l10n/app_en.arb:2681 ↔ lib/l10n/app_zh_Hant.arb:180 (T1 same ARB key) | evidenced | Label moved out of ReadinessMonitor.secondaryAir into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 失火監控 | misfire | lib/l10n/app_en.arb:2571 ↔ lib/l10n/app_zh_Hant.arb:174 (T1 same ARB key) | evidenced | Label moved out of ReadinessMonitor.misfire into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 已儲存 | stored | lib/l10n/app_en.arb:457 ↔ lib/l10n/app_zh_Hant.arb:738 (T1 same ARB key) | evidenced | Moved out of DtcKind when lib/obd/ stopped carrying screen copy. The enum still holds 已儲存 as `transcriptLabel`, which is export copy and stays Chinese in every locale — do not cite that as the UI translation. |
| 底盤 | chassis | lib/l10n/app_en.arb:2553 ↔ lib/l10n/app_zh_Hant.arb:745 (T1 same ARB key `dtcSystemChassis`) | evidenced |  |
| 待確認 | pending | lib/l10n/app_en.arb:457 ↔ lib/l10n/app_zh_Hant.arb:739 (T1 same ARB key) | evidenced | Not 'detected' and not 'confirmed': a Mode 07 code has been seen once and has not reached the confirmation threshold. |
...
| 網路 | network | lib/l10n/app_en.arb:52 ↔ lib/l10n/app_zh_Hant.arb:747 (T1 same ARB key) | evidenced |  |
...
| 車身 | body | lib/l10n/app_en.arb:130 ↔ lib/l10n/app_zh_Hant.arb:746 (T1 same ARB key) | evidenced |  |
...
| 原廠資料 | manufacturer data | lib/l10n/app_en.arb:2822 ↔ lib/l10n/app_zh_Hant.arb:933 (T1 same ARB key) | evidenced | The English was 'manufacturer publication' here while nothing shipped it. What ships is 'manufacturer data': shorter, and 'publication' invites the reader to expect a document they can go and read. |
...
| 官方型錄 | official registry | lib/l10n/app_en.arb:2818 ↔ lib/l10n/app_zh_Hant.arb:932 (T1 same ARB key) | evidenced | The strongest of the five origins. It must not be worded so as to sound like a measurement of this car — it is a record about this model. |
...
| 通用預設 | generic default | lib/l10n/app_en.arb:2810 ↔ lib/l10n/app_zh_Hant.arb:930 (T1 same ARB key) | evidenced | The weakest of the five origins, and the one a reader most needs to spot: it means the estimate is about a car, not about their car. |
| 模型係數 | model coefficient | lib/l10n/app_en.arb:2826 ↔ lib/l10n/app_zh_Hant.arb:934 (T1 same ARB key) | evidenced | A number from a physical model rather than from this vehicle. Never 'measured' and never 'official' — #44's rule about 推算 applies to it directly. |
