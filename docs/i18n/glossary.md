...
| MAF 感測器 | MAF sensor | lib/l10n/app_en.arb:2759 ↔ lib/l10n/app_zh_Hant.arb:910 (T1 same ARB key) | evidenced | INCONSISTENCY: this uses 感測器 while the readiness monitor label uses 感知器 for oxygen sensor (lib/l10n/app_zh_Hant.arb, dtcMonitorOxygenSensor). Both ship. Label moved out of AirflowSource.label into the ARBs so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 車身 | body | lib/l10n/app_en.arb:130 ↔ lib/l10n/app_zh_Hant.arb:752 (T1 same ARB key) | evidenced |  |
