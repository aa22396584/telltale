...
| MAF 感測器 | MAF sensor | lib/l10n/app_en.arb:2771 ↔ lib/l10n/app_zh_Hant.arb:913 (T1 same ARB key) | evidenced | INCONSISTENCY: this uses 感測器 while the readiness monitor label uses 感知器 for oxygen sensor (lib/l10n/app_zh_Hant.arb:177 '含氧感知器', dtcMonitorOxygenSensor). Both ship. Label moved out of AirflowSource.label into the ARBs so lib/obd stays Flutter-free; the enum still carries the identity. |
| OBD2 故障診斷 | OBD2 fault diagnosis | README.md:11 ↔ README.zh-TW.md:11 (T1 same sentence) | evidenced |  |
| Speed-Density 推算 | Speed-density estimate | lib/l10n/app_en.arb:2775 ↔ lib/l10n/app_zh_Hant.arb:914 (T1 same ARB key) | evidenced | Was proposed while the label lived in physics_engine.dart, which had no English at all. The English now ships and says estimate — the load-bearing half, because this figure is computed from RPM, MAP and IAT rather than read off a sensor. |
...
| 二次空氣噴射 | secondary air | lib/l10n/app_en.arb:2713 ↔ lib/l10n/app_zh_Hant.arb:180 (T1 same ARB key) | evidenced | Label moved out of ReadinessMonitor.secondaryAir into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 動力系統 | powertrain | lib/l10n/app_en.arb:1253 ↔ lib/l10n/app_zh_Hant.arb:753 (T1 same ARB key) | evidenced | Distinct from '大電池' used for 'powertrain battery' at README.md:58 ↔ README.zh-TW.md:52. Same English word, two zh renderings by domain. |
| 化學計量比推算 | Stoichiometric estimate | lib/l10n/app_en.arb:2783 ↔ lib/l10n/app_zh_Hant.arb:916 (T1 same ARB key) | evidenced |  |
...
| 失火監控 | misfire | lib/l10n/app_en.arb:2603 ↔ lib/l10n/app_zh_Hant.arb:174 (T1 same ARB key) | evidenced | Label moved out of ReadinessMonitor.misfire into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 已儲存 | stored | lib/l10n/app_en.arb:457 ↔ lib/l10n/app_zh_Hant.arb:747 (T1 same ARB key) | evidenced | Moved out of DtcKind when lib/obd/ stopped carrying screen copy. The enum still holds 已儲存 as `transcriptLabel`, which is export copy and stays Chinese in every locale — do not cite that as the UI translation. |
| 底盤 | chassis | lib/l10n/app_en.arb:2585 ↔ lib/l10n/app_zh_Hant.arb:754 (T1 same ARB key `dtcSystemChassis`) | evidenced |  |
| 待確認 | pending | lib/l10n/app_en.arb:457 ↔ lib/l10n/app_zh_Hant.arb:748 (T1 same ARB key) | evidenced | Not 'detected' and not 'confirmed': a Mode 07 code has been seen once and has not reached the confirmation threshold. |
...
| 永久 | permanent | lib/l10n/app_en.arb:2565 ↔ lib/l10n/app_zh_Hant.arb:749 (T1 same ARB key) | evidenced | A permanent code is NOT clearable, and English copy must never imply that pressing Clear removes it. dtcKindPermanentExplanation (lib/l10n/app_en.arb:2577 ↔ lib/l10n/app_zh_Hant.arb:752) carries 無法用診斷儀清除，需修復後由 ECU 自行確認 and its English; dtcClearDialogBody (lib/l10n/app_en.arb:457 ↔ lib/l10n/app_zh_Hant.arb:142) repeats it beside the Clear button. #45 names this explicitly |
...
| 網路 | network | lib/l10n/app_en.arb:52 ↔ lib/l10n/app_zh_Hant.arb:756 (T1 same ARB key) | evidenced |  |
...
| 車身 | body | lib/l10n/app_en.arb:2589 ↔ lib/l10n/app_zh_Hant.arb:755 (T1 same ARB key) | evidenced |  |
...
| 刪除 | delete | lib/l10n/app_en.arb:1963 ↔ lib/l10n/app_zh_Hant.arb:278 (T1 same ARB key) | evidenced |  |
| 匯出 | export | lib/l10n/app_en.arb:2044 ↔ lib/l10n/app_zh_Hant.arb:596 (T1); README.md:57 'export' ↔ README.zh-TW.md:51 '匯出' | evidenced |  |
| 回放 | replay | lib/l10n/app_en.arb:1966 ↔ lib/l10n/app_zh_Hant.arb:569 (T1 same ARB key) | evidenced |  |
...
| 繁體中文 | English | Evidence | Status | Note |
|---|---|---|---|---|
| 資料已過期 | stale | lib/l10n/app_en.arb:305 ↔ lib/l10n/app_zh_Hant.arb:666 (T1 same ARB key) | evidenced | #45 names this explicitly: stale ≠ live. A reading that stopped updating is not a current one, and must never render as though it were |
| ECU 回報 | ECU reported | lib/l10n/app_en.arb:419 ↔ lib/l10n/app_zh_Hant.arb:724 (T1 same ARB key, `derivedEcuReported`) | evidenced | The identifier for the fuel case says `measured`; both shipped strings say the ECU reported it. #44 forbids rendering 推算/estimate as measured, and using the bare word for the true case invites exactly that slip, so the English names the reporter rather than the act of measuring. `derivedFuelSourceEcu` briefly held a second, byte-identical copy of this sentence and was merged away. |
...
| 原廠資料 | manufacturer data | lib/l10n/app_en.arb:2850 ↔ lib/l10n/app_zh_Hant.arb:941 (T1 same ARB key) | evidenced | The English was 'manufacturer publication' here while nothing shipped it. What ships is 'manufacturer data': shorter, and 'publication' invites the reader to expect a document they can go and read. |
...
| 官方型錄 | official registry | lib/l10n/app_en.arb:2846 ↔ lib/l10n/app_zh_Hant.arb:940 (T1 same ARB key) | evidenced | The strongest of the five origins. It must not be worded so as to sound like a measurement of this car — it is a record about this model. |
...
| 通用預設 | generic default | lib/l10n/app_en.arb:2838 ↔ lib/l10n/app_zh_Hant.arb:938 (T1 same ARB key) | evidenced | The weakest of the five origins, and the one a reader most needs to spot: it means the estimate is about a car, not about their car. |
| 模型係數 | model coefficient | lib/l10n/app_en.arb:2854 ↔ lib/l10n/app_zh_Hant.arb:942 (T1 same ARB key) | evidenced | A number from a physical model rather than from this vehicle. Never 'measured' and never 'official' — #44's rule about 推算 applies to it directly. |
