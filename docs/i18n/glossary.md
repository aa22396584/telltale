...
| 內建模擬器 | built-in simulator | lib/l10n/app_en.arb:79 ↔ lib/l10n/app_zh_Hant.arb:41 (T1 same ARB key) | evidenced | The in-app label is 'Demo 模擬器' (docs/field-guide.zh-TW.md:27); the ARB says 內建模擬器; README says Demo ECU. Pick per surface, do not unify silently. |
...
| 轉接器 | adapter | README.md:11 'ELM327-compatible adapter' ↔ README.zh-TW.md:10 'ELM327 相容轉接器' (T1); lib/l10n/app_en.arb:40 ↔ lib/l10n/app_zh_Hant.arb:25 | evidenced | Never 適配器/配接器. 轉接器 is used throughout README.zh-TW, field-guide and lib/. |
| 選擇連線方式 | Choose a connection | lib/l10n/app_en.arb:106 ↔ lib/l10n/app_zh_Hant.arb:56 (T1 same ARB key) | evidenced |  |
| 電門 | ignition | lib/l10n/app_en.arb:54 ↔ lib/l10n/app_zh_Hant.arb:30 (T1 same ARB key) | evidenced | 電門 (not 點火/鑰匙門). Reused throughout docs/field-guide.zh-TW.md:59,145,146,267,298. |
...
| Language / 語言 | Language / 語言 | lib/l10n/app_en.arb:740 ↔ lib/l10n/app_zh_Hant.arb:217 (T1 same ARB key) | evidenced | DO NOT localize. app_en.arb:10 description: 'Bilingual label for the language picker. Options use self-names.' |
...
| 刪除 | delete | lib/l10n/app_en.arb:1786 ↔ lib/l10n/app_zh_Hant.arb:245 (T1 same ARB key) | evidenced |  |
| 匯出 | export | lib/l10n/app_en.arb:49 ↔ lib/l10n/app_zh_Hant.arb:31 (T1); README.md:57 'export' ↔ README.zh-TW.md:51 '匯出' | evidenced |  |
| 回放 | replay | lib/l10n/app_en.arb:1789 ↔ lib/l10n/app_zh_Hant.arb:527 (T1 same ARB key) | evidenced |  |
...
| 設定 | Settings | lib/l10n/app_en.arb:41 settingsHeadline ↔ lib/l10n/app_zh_Hant.arb:26 (T1) | evidenced |  |
...
| 重試 | Retry | lib/l10n/app_en.arb:563 ↔ lib/l10n/app_zh_Hant.arb:165 (T1 same ARB key) | evidenced |  |
...
| 繁體中文 | English | Evidence | Status | Note |
|---|---|---|---|---|
| 資料已過期 | stale | lib/l10n/app_en.arb:665 ↔ lib/l10n/app_zh_Hant.arb:624 (T1 same ARB key) | evidenced | #45 names this explicitly: stale ≠ live. A reading that stopped updating is not a current one, and must never render as though it were |
