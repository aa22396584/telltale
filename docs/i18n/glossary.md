...
| 動力系統 | powertrain | lib/l10n/app_en.arb:1384 ↔ lib/l10n/app_zh_Hant.arb:792 (T1 same ARB key) | evidenced | Distinct from '大電池' used for 'powertrain battery' at README.md:58 ↔ README.zh-TW.md:52. Same English word, two zh renderings by domain. |
...
| 工作階段 | session | README.md:118 'session dated 2026-08-27' ↔ README.zh-TW.md:99 '復原工作階段紀錄' (T1); README.md:156 ↔ README.zh-TW.md:132-133 | evidenced | Not 會話/場次. lib/obd/session_evidence.dart:139 ships '# Telltale OBD 工作階段紀錄 v1'. |
...
| 匯出 | export | lib/l10n/app_en.arb:2210 ↔ lib/l10n/app_zh_Hant.arb:629 (T1); README.md:57 'export' ↔ README.zh-TW.md:51 '匯出' | evidenced |  |
...
| VE | VE | README.md:75 ↔ README.zh-TW.md:65 (T1 — unchanged); spelled out as 容積效率 in lib/obd/session_evidence.dart:217 'volumetricEfficiency' | evidenced |  |
...
| 車重 | mass | README.md:75 'does not infer mass, torque, drag, VE' ↔ README.zh-TW.md:65 '不推測車重、扭力、風阻、VE' (T1); lib/obd/session_evidence.dart:216 'massKg' => '車重' | evidenced |  |
...
| 風阻 | drag | README.md:75 ↔ README.zh-TW.md:65 (T1); lib/obd/session_evidence.dart:220 'dragCoefficient' => '風阻係數' | evidenced |  |
...
| 驅動方式 | drivetrain | lib/obd/session_evidence.dart:219 'drivetrain' => '驅動方式' (T3); README.zh-TW.md:66 '風阻與驅動方式' | evidenced |  |
