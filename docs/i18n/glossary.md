...
| MAF 感測器 | MAF sensor | lib/l10n/app_en.arb:2901 ↔ lib/l10n/app_zh_Hant.arb:942 (T1 same ARB key) | evidenced | INCONSISTENCY: this uses 感測器 while the readiness monitor label uses 感知器 for oxygen sensor (lib/l10n/app_zh_Hant.arb:190 '含氧感知器', dtcMonitorOxygenSensor). Both ship. Label moved out of AirflowSource.label into the ARBs so lib/obd stays Flutter-free; the enum still carries the identity. |
| OBD2 故障診斷 | OBD2 fault diagnosis | README.md:11 ↔ README.zh-TW.md:11 (T1 same sentence) | evidenced |  |
| Speed-Density 推算 | Speed-density estimate | lib/l10n/app_en.arb:2905 ↔ lib/l10n/app_zh_Hant.arb:943 (T1 same ARB key) | evidenced | Was proposed while the label lived in physics_engine.dart, which had no English at all. The English now ships and says estimate — the load-bearing half, because this figure is computed from RPM, MAP and IAT rather than read off a sensor. |
...
| 二次空氣噴射 | secondary air | lib/l10n/app_en.arb:2843 ↔ lib/l10n/app_zh_Hant.arb:193 (T1 same ARB key) | evidenced | Label moved out of ReadinessMonitor.secondaryAir into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 動力系統 | powertrain | lib/l10n/app_en.arb:1372 ↔ lib/l10n/app_zh_Hant.arb:782 (T1 same ARB key) | evidenced | Distinct from '大電池' used for 'powertrain battery' at README.md:58 ↔ README.zh-TW.md:52. Same English word, two zh renderings by domain. |
| 化學計量比推算 | Stoichiometric estimate | lib/l10n/app_en.arb:2913 ↔ lib/l10n/app_zh_Hant.arb:945 (T1 same ARB key) | evidenced |  |
...
| 失火監控 | misfire | lib/l10n/app_en.arb:2733 ↔ lib/l10n/app_zh_Hant.arb:187 (T1 same ARB key) | evidenced | Label moved out of ReadinessMonitor.misfire into the ARBs (L04) so lib/obd stays Flutter-free; the enum still carries the identity. |
...
| 底盤 | chassis | lib/l10n/app_en.arb:2715 ↔ lib/l10n/app_zh_Hant.arb:783 (T1 same ARB key `dtcSystemChassis`) | evidenced |  |
...
| 車身 | body | lib/l10n/app_en.arb:2719 ↔ lib/l10n/app_zh_Hant.arb:784 (T1 same ARB key) | evidenced |  |
...
| 刪除 | delete | lib/l10n/app_en.arb:2093 ↔ lib/l10n/app_zh_Hant.arb:291 (T1 same ARB key) | evidenced |  |
| 匯出 | export | lib/l10n/app_en.arb:2174 ↔ lib/l10n/app_zh_Hant.arb:619 (T1); README.md:57 'export' ↔ README.zh-TW.md:51 '匯出' | evidenced |  |
| 回放 | replay | lib/l10n/app_en.arb:2096 ↔ lib/l10n/app_zh_Hant.arb:592 (T1 same ARB key) | evidenced |  |
...
| 原廠資料 | manufacturer data | lib/l10n/app_en.arb:2980 ↔ lib/l10n/app_zh_Hant.arb:970 (T1 same ARB key) | evidenced | The English was 'manufacturer publication' here while nothing shipped it. What ships is 'manufacturer data': shorter, and 'publication' invites the reader to expect a document they can go and read. |
...
| 官方型錄 | official registry | lib/l10n/app_en.arb:2976 ↔ lib/l10n/app_zh_Hant.arb:969 (T1 same ARB key) | evidenced | The strongest of the five origins. It must not be worded so as to sound like a measurement of this car — it is a record about this model. |
...
| 通用預設 | generic default | lib/l10n/app_en.arb:2968 ↔ lib/l10n/app_zh_Hant.arb:967 (T1 same ARB key) | evidenced | The weakest of the five origins, and the one a reader most needs to spot: it means the estimate is about a car, not about their car. |
| 模型係數 | model coefficient | lib/l10n/app_en.arb:2984 ↔ lib/l10n/app_zh_Hant.arb:971 (T1 same ARB key) | evidenced | A number from a physical model rather than from this vehicle. Never 'measured' and never 'official' — #44's rule about 推算 applies to it directly. |
