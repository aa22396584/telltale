/// Self-contained SHA-256 for offline catalog manifests.
///
/// Kept here rather than importing `package:crypto`, which is only a
/// transitive dependency of this application.
library;
