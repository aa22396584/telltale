...
/// Sealed result of parsing a Mode 08 discovery response.
...
/// Negative response returned by ECU (e.g. 7F 08 11 or 7F 08 12).
final class Mode08NegativeResponse extends Mode08ParseResult {
  ...
  EcuSupportStatus get supportStatus => EcuSupportStatus.unsupported;
}
