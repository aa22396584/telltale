/// #47 leftover: after Demo, assert Dashboard Gauges copy, then English.
/// Production providers; the session is not replaced with a pre-solved mock.
///
///     flutter test integration_test/localization_gauges_journey_test.dart -d <device-id> \
...
void main() {
  ...
  testWidgets('Gauges copy follows a language switch after Demo', (
    tester,
  ) async {
